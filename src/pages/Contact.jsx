        ...
        <div className="container mx-auto">
          <div className="flex flex-col lg:flex-row w-full h-full gap-x-10">
            ...
            <div className="flex-1 flex flex-col gap-y-2">
              ...
              <div className="flex items-center justify-between w-full">
                ...
                <p className="flex items-center gap-x-2 w-full">
                  <AiFillPhone className="text-xl text-primary" /> +562 12345678
                </p>
              </div>
              <p className="flex items-center gap-x-2 w-full">
            ...
            <div className="flex-1 flex flex-col h-full shadow-2xl py-20 lg:px-12">
              <h3 className="text-[20px] font-semibold lg:text-2xl uppercase lg:mb-10 px-9 w-full">
              ...
              <form action="" className="flex flex-col gap-y-3 p-10 rounded-lg">
                ...
                <div className="flex justify-between gap-x-5">
                  ...
                  <div className="flex-1 flex-col">
                    <label htmlFor="solicitud text-[11px]">
                      Tipo de Solicitud:
                    </label>
                    <select
                      id="solicitud"
