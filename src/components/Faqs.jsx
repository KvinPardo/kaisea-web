...
const Faqs = () => {
  ...
  return (
    <section className=" section flex justify-between items-center h-full w-full pb-52">
      <div className="max-w-[768px] mx-auto relative h-full z-20">
        <div className="absolute top-[50%] left-[50%] -translate-x-[50%] h-full -translate-y-[50%] flex flex-col justify-center lg:items-center items-center w-full lg:max-w-[800px] z-10">
          <FaQuestion className="lg:text-[600px] hidden lg:flex text-gray-300/40  h-full" />
        </div>
        {/* section title */}
